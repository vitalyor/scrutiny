...
import (
	...
	"github.com/analogj/scrutiny/webapp/backend/pkg/web/collect"
...
func (ae *AppEngine) Setup(logger *logrus.Entry) *gin.Engine {
	...
	if ae.CollectRunner == nil {
		ae.CollectRunner = collect.NewRunner(logger)
	}
	handler.SetCollectRunner(ae.CollectRunner)
